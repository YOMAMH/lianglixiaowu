...
function editRow ( oTable, nRow )
{
    ...
    jqTds[5].innerHTML = '<input type="file" value="'+aData[5]+'">';
    ...
    jqTds[10].innerHTML = '<a class="edit-row" href="javascript:void(0)">保存</a>';
}
...
function saveRow ( oTable, nRow )
{
    ...
    oTable.fnUpdate( '<a class="edit-row" href="javascript:void(0)">编辑</a>', nRow, 10, false );
    oTable.fnDraw();
}
